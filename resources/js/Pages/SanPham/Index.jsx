...
export default function Index({ sanPhams }) {
        ...
        <AdminLayout
            header={
                <div className="flex items-center justify-between">
                    ...
                    <Link href={route('san-pham.create')}>
                        <PrimaryButton>Thêm Sản Phẩm</PrimaryButton>
                    </Link>
                </div>
            }
        >
                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                                                ...
                                                <tr key={sanPham.MASP}>
                                                    ...
                                                    <td className="whitespace-nowrap px-6 py-4 text-right text-sm font-medium">
                                                        <div className="flex items-center justify-end space-x-2">
                                                            <Link
                                                                href={route('san-pham.show', sanPham.MASP)}
                                                            ...
                                                            <Link
                                                                href={route('san-pham.edit', sanPham.MASP)}
                                                            ...
                                                            <DeleteButton
                                                                routeName="san-pham.destroy"
                                                                routeParams={sanPham.MASP}
                                                            />
                                                        </div>
                                                    </td>
                                                </tr>
                            ...
                            <Pagination links={sanPhams.links} />
                        </div>
                    </div>
                </div>
            </div>
